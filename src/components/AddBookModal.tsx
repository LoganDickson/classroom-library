...
export default function AddBookModal({ onClose, onBookAdded }: Props) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${showScanner ? "hidden" : ""}`}>
        <div
        ...
        <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative z-10">
          ...
          <button
            ...
            className="w-full border border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-2 rounded-lg text-sm transition-colors mb-6"
          >
            📷 Scan Barcode
          </button>
